...
DOWNLOADER_MIDDLEWARES = {
   'tujia.middlewares.RandomAgentMiddleware': 543,
}
...
ITEM_PIPELINES = {
   'tujia.pipelines.CheckInDatePipeline': 300,
   'tujia.pipelines.MongoPipeline': 400,
}
...
FORM_DATA = {'hasPic': 'false',
			 'pageIndex': 0,
			 'pageSize': 5000,
			 'recommended': 'false'}
UNIT_ID = [18784, 476586, 1081474, 268126]
